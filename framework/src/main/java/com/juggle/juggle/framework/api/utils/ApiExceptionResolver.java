package com.juggle.juggle.framework.api.utils;
...
import com.juggle.juggle.framework.common.i18n.MessageMaker;
import com.juggle.juggle.framework.common.i18n.meta.I18n;
...
public class ApiExceptionResolver implements HandlerExceptionResolver, Ordered {
	...
	private String handleFieldError(FieldError error) {
		ConstraintViolation cv = error.unwrap(ConstraintViolation.class);
    	return handleConstraintViolation(cv);
	}

	private String handleConstraintViolation(ConstraintViolation cv) {
	...
	private String simplizeMessageKey(String message) {
	...
	private String getI18nPrefix(Class clazz) {
	...
	private String replaceAttributes(Map<String, Object> attrs, String message) {
