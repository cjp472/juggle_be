...
import com.juggle.juggle.framework.data.json.FormulaDedutor;
...
import com.juggle.juggle.framework.data.json.meta.ExtGroup;
...
public class ExtBeanSerializer extends BeanSerializerBase
{
        ...
        throws IOException
    {
        ...
        if (null == ExtViewContext.get().getGroup()) {
            ExtGroup groupDef = bean.getClass().getAnnotation(ExtGroup.class);
            if (null != groupDef) {
                ExtViewContext.get().setGroup(groupDef.value());
            }
        }
        ...
        if (null != bean.getClass().getAnnotation(ExtView.class)) {
	        ...
	        try {
	        	if (ExtViewContext.get().getLevel() <= 1) {
