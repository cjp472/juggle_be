package com.juggle.juggle.framework.http;
...
import com.juggle.juggle.framework.http.resp.IResponseHandler;
...
public class SyncHttpClient {
	...
	public void postWithJson(URI uri, Object data, IResponseHandler handler, Map<String, String> headers) {
		...
		try {
			...
			throw new ServiceException(StandardErrors.EXTERNAL_ERROR.getStatus(), ex.getMessage());
		} finally {
	...
	public void upload(URI uri, String filename, InputStream is, Map<String, String> parameters) {
		try {
			...
			httpPost.setEntity(entity);
			//发送请求
			HttpResponse response = buildClient().execute(httpPost);
