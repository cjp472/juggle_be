...
import com.juggle.juggle.primary.taobao.forumal.CalTaobaoFavourableSnapshot;
...
@Entity
@Table(name = "taobao_favourable")
@Formula(value="snapshot",calc = CalTaobaoFavourableSnapshot.class)
@ExtView
public class TaobaoFavourable extends LongEntity {
    @Filtered
    @State(Constants.TAOBAO_FAVOURABLE_TYPE.class)
    private String type;
    ...
    @Transient
    private String sub = Constants.TAOBAO_SUB.FAVOURABLE;
