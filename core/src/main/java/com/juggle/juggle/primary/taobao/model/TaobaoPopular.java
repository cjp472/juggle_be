...
import com.juggle.juggle.primary.taobao.forumal.CalTaobaoPopularSnapshot;
...
@Entity
@Table(name="taobao_popular")
@Formula(value="snapshot",calc = CalTaobaoPopularSnapshot.class)
@ExtView
public class TaobaoPopular extends LongEntity {
    @Filtered
    @State(Constants.TAOBAO_POPULAR_TYPE.class)
    private String type;
    ...
    @Transient
    private String sub = Constants.TAOBAO_SUB.POPULAR;
